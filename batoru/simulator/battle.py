    ...
    def tournament(self):
        ...
        for tournament_round in table:
            for match in tournament_round:
                ...
                compete_id = str(tournament.tournament_id) + "."\
                    + str(tournament_fight_id)
                winner = self.compete(compete_id, player_one, player_two)
